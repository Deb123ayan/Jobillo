...
import { Users, Video, MessageCircle, Share, Plus, LogIn } from "lucide-react";
  ...
  const createRoomMutation = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      localStorage.setItem(
        `participant_${joinData.room.id}`,
        JSON.stringify(joinData.participant),
      );
  ...
  const joinRoomMutation = useMutation({
    ...
    onError: () => {
      toast({
        title: "Error",
        description:
          "Room not found or invalid code. Please check and try again.",
        variant: "destructive",
      });
    },
  });
      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 text-sm font-medium rounded-full mb-8">
            ...
            Simple Interviews • Video Calls • Real-time Chat
          </div>
          ...
          <p className="text-xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            Simple and effective interview platform with video calls
            and real-time chat. No login required - just create a room
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="text-center p-6">
            ...
            <p className="text-slate-600">
              Instant messaging during interviews for better communication
            </p>
          </div>
          <div className="text-center p-6">
            ...
            <p className="text-slate-600">
              Share your screen to review code or discuss concepts
            </p>
          </div>
        </div>
      </main>
